...
#
# Original here: https://gist.github.com/marioizquierdo/2dfb0f4afcdbc549e10b
#
...
class Tag
  constructor: (@tagName, @attributes = {}, @text = "") ->
    ...
    if @attributes['escapeAttributes']
      delete @attributes['escapeAttributes']
      for key, attribute of @attributes
        @attributes[key] = HAML.escape(attribute)
...
FormHelpers =
  ...
  linkTo: (text, href, attrs = {}) ->
    attrs['href'] ||= href
    Tag.make 'a', attrs, text

  iframe: (attrs = {}) ->
    Tag.make 'iframe', attrs
